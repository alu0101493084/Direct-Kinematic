...
if len(sys.argv) == 1:
  sys.exit('The expected parameters are: L1 θ2 L3 θ4 θ5')
sys.argv.pop(0)
parameters = sys.argv
...
# Parámetros D-H:
#              1          2    2'         3               4              51               52      EF
d  = [ values[0],         0,   0, values[2],              0,              0,               0,      0]
th = [         0, values[1], -90,       -90,      values[3],  values[4] -90, -values[4] - 90,    -90]
a  = [         0,         5,   0,         0,              0,              2,               2,      2]
...
while True:
  ...
  T221 = matriz_T(d[2], th[2], a[2], al[2])
  T021 = np.dot(T02, T221)

  T213 = matriz_T(d[3], th[3], a[3], al[3])
  T03 = np.dot(T021, T213)
  ...
  o210 = np.dot(T021, origin).tolist()
  ...
  muestra_origenes([o00, o10, o20, o210, o30, o40, [[o510], [o520]]], oEF)
  muestra_robot([o00, o10, o20, o210, o30, o40, [[o510], [o520]]], oEF)
